...
CORS_ALLOWED_HOSTS_PER_URL_REGEX_DEFAULT = {
    CORS_URLS_REGEX: {
        'ALL_ALLOWED': CORS_ORIGIN_ALLOW_ALL,
        'WHITELIST': CORS_ORIGIN_WHITELIST
    }
}
CORS_ALLOWED_HOSTS_PER_URL_REGEX = getattr(settings, 'CORS_ALLOWED_HOSTS_PER_URL_REGEX',
                                           CORS_ALLOWED_HOSTS_PER_URL_REGEX_DEFAULT)
